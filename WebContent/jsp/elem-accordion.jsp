    ...
    <div class="slim-navbar">
      <div class="container">
        <ul class="nav">
          ...
          <li class="nav-item with-sub mega-dropdown active">
            <a class="nav-link" href="#">
              ...
              <div class="row">
                <div class="col-lg-5">
                  ...
                  <div class="row">
                    <div class="col">
                      <ul>
                        <li class="active"><a href="elem-accordion.html">Accordion</a></li>
          ...
          <div id="accordion3" class="accordion-two" role="tablist" aria-multiselectable="true">
            <div class="card">
              <div class="card-header" role="tab" id="headingOne3">
                <a data-toggle="collapse" data-parent="#accordion3" href="#collapseOne3" aria-expanded="true" aria-controls="collapseOne3" class="tx-gray-800 transition">
                  Making a Beautiful CSS3 Button Set
                </a>
              </div><!-- card-header -->
            ...
            <div class="card">
              <div class="card-header" role="tab" id="headingTwo3">
                <a class="collapsed tx-gray-800 transition" data-toggle="collapse" data-parent="#accordion3" href="#collapseTwo3" aria-expanded="false" aria-controls="collapseTwo3">
                  Horizontal Navigation Menu Fold Animation
                </a>
              </div>
            ...
            <div class="card">
              <div class="card-header" role="tab" id="headingThree3">
                <a class="collapsed tx-gray-800 transition" data-toggle="collapse" data-parent="#accordion3" href="#collapseThree3" aria-expanded="false" aria-controls="collapseThree3">
                  Creating CSS3 Button with Rounded Corners
                </a>
              </div>
